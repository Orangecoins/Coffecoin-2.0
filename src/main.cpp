...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	// stake age of full weight: 40d
unsigned int nStakeTargetSpacing = 20;			// 30 sec block spacing

int64 nChainStartTime = 1401200841;
...
const string strMessageMagic = "CoffeeCoin2.0 Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 1500000;	// 365 * 2880
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	if(nHeight < YEARLY_BLOCKCOUNT)
		...
		nRewardCoinYear = 9.5 * MAX_MINT_PROOF_OF_STAKE;
	else if(nHeight < (3 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 9.025 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (4 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 8.5783 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (5 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 8.1450625 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (6 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 7.7378094 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (7 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 7.3509189 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (8 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 6.983373 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (9 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 6.6342043 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (10 * YEARLY_BLOCKCOUNT))
         nRewardCoinYear = 6.3024941 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (11 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 5.9873694 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (12 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 5.6880009 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (13 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 5.4036009 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (14 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 5.1334208 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (15 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 4.8767498 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (16 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 4.6329123 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (17 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 4.4012667 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (18 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 4.1812034 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (19 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.9721432 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (20 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.773536 * MAX_MINT_PROOF_OF_STAKE;
     else if(nHeight < (21 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.5848592 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (22 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.4056163 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (23 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.2353354 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (24 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 3.0735687 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (25 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.9198902 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (26 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.7738957 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (27 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.6352009 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (28 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.5034409 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (29 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.3782689 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (30 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.2593554 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (31 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.1463876 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (32 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2.0390683 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (33 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 1.9371148 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (34 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 18402591 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (35 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 17482461 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (36 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 16608338 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (37 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 15777921 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (38 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 14989025 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (39 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 14239574 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (40 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 13527595 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (41 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 12851216 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (42 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 12208655 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (43 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 11598222 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (44 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 11018311 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (45 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 1.0467395 * MAX_MINT_PROOF_OF_STAKE;
    else if(nHeight < (500 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE;
...
static const int64 nTargetTimespan = 20 * 10;  
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CoffeeCoin2.0
    bool fStrictPayToScriptHash = true; // Always active in CoffeeCoin2.0
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoffeeCoin2.0", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Orange Mocha Franpachino to the moon.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xc1a8d74e63fc995e6fcf0954e4b231cde0e5f927e9af9baa22521c51f7112196"));
...
unsigned char pchMessageStart[4] = { 0xc2, 0xe5, 0xb3, 0xc3 };
